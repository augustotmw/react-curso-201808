        ...
        return (
            <article className="tweet" onClick={this.props.abrir}>
                ...
                <footer className="tweet__footer">
                    <button className="btn btn--clean" onClick={this.props.likeIt}>
                        <svg className={`icon icon--small iconHeart ${ this.props.info.likeado ? 'iconHeart--active' : ''}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 47.5 47.5">
                            <defs>
                                <clipPath id="a">
                        ...
                        { /*this.state.todosLikes*/
                            ...
                            this.props.info.totalLikes
                        }
                    </button>
                    {
                        this.props.info.removivel && 
